...
const Poster = (props) => {
    return (
        <>
        <div className="flex flex-col items-start gap-1 px-1 left-8">
            <div className="h-96 w-64">
                <img src={props.src} alt={props.title} className="w-full h-full rounded-xl"/>
            </div>
            <h3 className={`font-bold text-lg items-start break-normal leading-6 dark:text-gray-300 text-gray-800" }`}>{props.title}</h3>
